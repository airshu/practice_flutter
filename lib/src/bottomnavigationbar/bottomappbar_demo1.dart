...
class BottomAppBarDemo1Widget extends StatefulWidget {
  const BottomAppBarDemo1Widget({Key? key}) : super(key: key);

  @override
  State createState() => _BottomAppBarDemo1WidgetState();
}

class _BottomAppBarDemo1WidgetState extends State<BottomAppBarDemo1Widget> {
  bool _showFab = true;
