...
class ShareDemoApp extends StatefulWidget {
  const ShareDemoApp({Key? key}) : super(key: key);

  @override
  ShareDemoAppState createState() => ShareDemoAppState();
}

class ShareDemoAppState extends State<ShareDemoApp> {
  String text = '';
  String subject = '';
